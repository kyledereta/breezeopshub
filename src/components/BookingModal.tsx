          ...
          <form onSubmit={form.handleSubmit(handleFormSubmit)} className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              {(() => {
                ...
                // For grouped bookings, include sibling totals and deposits
                let groupTotalAmt = totalAmt;
                let groupDpAmt = dpAmt;
                if (isEditing && groupSiblings.length > 0) {
                  groupSiblings.forEach((sib) => {
                    ...
                    const sibTotal = Math.max(0, sibBase + sibExtras - sibDiscountAmt);
                    groupTotalAmt += sibTotal > 0 ? sibTotal : sib.total_amount;
                    groupDpAmt += sib.deposit_paid;
                  });
                }
